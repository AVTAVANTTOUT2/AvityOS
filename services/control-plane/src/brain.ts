    ...
    const persisted = this.store.createBrainPlan({
      ...
      missions: proposal.missions.map((mission) => ({
        ...
        contract: {
          ...
          workspaceChangesRequired: project.repoPath !== null && mission.workspaceChangesRequired,
...
const STEP_INSTRUCTIONS: Readonly<Record<BrainStep, string>> = {
  ...
  plan: [
    ...
    '   "checkCommands": {"<check>": string[]}, "expectedArtifacts": string[], "workspaceChangesRequired": boolean,',
